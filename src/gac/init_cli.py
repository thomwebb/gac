...
def init() -> None:
    ...
    click.echo("\nYou can now run 'uvx gac' in any Git repository to generate commit messages.")
    click.echo("Run 'uvx gac --help' to see available options.")
    click.echo("Run 'uvx gac init' again at any time to change your settings.")
