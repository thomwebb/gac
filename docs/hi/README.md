...
```bash
gac stats               # अवलोकन: कुल gac, स्ट्रीक, दैनिक/साप्ताहिक पीक, शीर्ष प्रोजेक्ट और मॉडल
gac stats models        # मॉडल विवरण: gac, टोकन, विलंबता, गति
gac stats projects      # प्रोजेक्ट विवरण: सभी रेपो में gac, कमिट, टोकन
gac stats reset         # सभी आँकड़े रीसेट करें (पुष्टि आवश्यक)
gac stats reset model <model-id>  # केवल एक विशिष्ट मॉडल के आँकड़े रीसेट करें
```
