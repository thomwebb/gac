...
uvx gac में बिल्ट-इन सिक्योरिटी स्कैनिंग शामिल है जो स्वचालित रूप से आपके स्टेज्ड परिवर्तनों में संभावित सीक्रेट्स और API कुंजियों का पता लगाती है। यह गलती से संवेदनशील जानकारी कमिट करने से रोकने में मदद करता है।
...
- `uvx gac stats show` — अपनी gac उपयोग सांख्यिकी देखें (कुल, स्ट्रीक, दैनिक और साप्ताहिक गतिविधि, टोकन उपयोग, शीर्ष प्रोजेक्ट, शीर्ष मॉडल)
- `uvx gac stats models` — सभी मॉडल के लिए टोकन विवरण और गति तुलना चार्ट के साथ विस्तृत आँकड़े देखें
- `uvx gac stats projects` — सभी प्रोजेक्ट के लिए टोकन विवरण के साथ आँकड़े देखें
...
| `uvx gac stats models`                 | **सभी** उपयोग किए गए मॉडल के लिए टोकन विवरण और गति तुलना चार्ट के साथ विस्तृत आँकड़े दिखाएं                       |
| `uvx gac stats projects`               | **सभी** प्रोजेक्ट के लिए टोकन विवरण के साथ सांख्यिकी दिखाएं                                                       |
| `uvx gac stats reset`                  | सभी सांख्यिकी को शून्य पर रीसेट करें (पुष्टि के लिए प्रॉम्प्ट करता है)                                            |
| `uvx gac stats reset model <model-id>` | किसी विशिष्ट मॉडल की सांख्यिकी रीसेट करें (बड़े/छोटे अक्षरों में भेद नहीं)                                        |
...
Running `uvx gac stats projects` **सभी** प्रोजेक्ट दिखाता है (केवल शीर्ष 5 नहीं) जिनमें:
...
Running `uvx gac stats models` **सभी** मॉडल दिखाता है (केवल शीर्ष 5 नहीं) जिनमें:
