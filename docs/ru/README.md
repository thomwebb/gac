...
uvx gac stats models        # Разбивка по моделям: gac-коммиты, токены, задержка, скорость
uvx gac stats projects      # Разбивка по проектам: gac-коммиты, коммиты, токены во всех репозиториях
