...
- `GAC_REASONING_EFFORT=medium` - Kontrollera resonemangs-/tankedjup för modeller som stöder utökat tänkande (low, medium, high, max). Lämna oinställt för att använda varje modells standard. Skickas endast till kompatibla leverantörer (OpenAI-stil; inte Anthropic).
